 ...
 */
public class ForgetPasswdFragment2 extends BaseFragment {
...
//                send();
                ...
                try {
                    if (CheckUtil.isNull(jsonStr)) {
                        ...
                        if (json.getInt("code") == 1) {
                            ...
                            ((ContentActivity)mContext).changeFragment(ChangePasswdFragment2.class.getName()
                                    ,true,true);
                        } else {
                            showToast("获取验证码失败");
                        }
    ...
    private void toNext() {
        ((ContentActivity)mContext).changeFragment(ChangePasswdFragment2.class.getName(),true,true);
    }
