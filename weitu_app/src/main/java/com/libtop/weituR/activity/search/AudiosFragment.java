 ...
 */
public class AudiosFragment extends NotifyFragment {
    @Bind(R.id.list)
...
//        bo = new HistoryBo(context);
    ...
    public void onMessage(MessageEvent event) {
        ...
        if (this.isVisible()&&pageIndex==ResultFragment.AUDIO){
...
//        RequestProxy.getInstance().post(ContantsUtil.HOST_ADDON + "/search/listByCate.json", params, new Callback.Base() {
//            @Override
