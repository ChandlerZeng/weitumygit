...
public class RegInfoFragment extends BaseFragment
{
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.back_btn:
                ...
                break;
            case R.id.school:
                ((ContentActivity) mContext).changeFragment(LibraryFragment.class.getName(), true, true);
                break;
        }
    }
    ...
    {
        super.onResume();
        String schoolId = mPreference.getString(Preference.SchoolCode);
    ...
    private void nextStep()
    {
        ...
        params.put("lid", Preference.instance(mContext).getString(Preference.SchoolCode));
