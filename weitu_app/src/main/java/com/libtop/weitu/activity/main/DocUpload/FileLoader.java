...
public class FileLoader extends AsyncTaskLoader<List<File>>
{
    ...
    private static final int FILE_OBSERVER_MASK = FileObserver.CREATE | FileObserver.DELETE | FileObserver.DELETE_SELF | FileObserver.MOVED_FROM | FileObserver.MOVED_TO | FileObserver.MODIFY | FileObserver.MOVE_SELF;
    ...
    private FileFilter fileTypeFilter = new FileFilter()
    {
        ...
        public boolean accept(File file)
        {
            ...
            return file.isFile() && !fileName.startsWith(".") && (fileName.endsWith("doc") || fileName.endsWith("xls") || fileName.endsWith("ppt") || fileName.endsWith("docx") || fileName.endsWith("xlsx") || fileName.endsWith("pptx") || fileName.endsWith("pdf") || fileName.endsWith("odt") || fileName.endsWith("ods"));
        }
    };
