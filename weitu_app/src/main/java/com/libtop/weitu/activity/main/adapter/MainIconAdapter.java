...
public class MainIconAdapter extends BaseAdapter<String>
{
    ...
    private int[] icons = {R.drawable.intelligence_search, R.drawable.book_icon, R.drawable.class_icon, R.drawable.schedule, R.drawable.video_icon, R.drawable.music_icon, R.drawable.doc_icon, R.drawable.image_icon};
